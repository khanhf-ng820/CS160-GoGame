...
execute_process(
  COMMAND "/usr/local/bin/git" --git-dir=.git show-ref "v1.3.5"
  WORKING_DIRECTORY "/Users/admin/Desktop/HK1 25-26/CS160/CS160-GoGame/build/_deps/ogg-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/admin/Desktop/HK1 25-26/CS160/CS160-GoGame/build/_deps/ogg-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/admin/Desktop/HK1 25-26/CS160/CS160-GoGame/build/_deps/ogg-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
